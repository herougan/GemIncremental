...
namespace TowerDefence.Skills
{
	...
	{
		public EntityResourceType ResourceType { get; private set; }
		public double RequiredAmount { get; private set; }
		public MathOperation Comparative { get; private set; }
		public override ConditionType ConditionType => ConditionType.Resource;

		public ResourceCondition(EntityResourceType resourceType, double requiredAmount, MathOperation comparative) : base(ConditionType.Resource)
		{
	...
	public class EntityInventoryCondition : Condition
	{
		...
		{
			ItemType = ItemType.None; // Default value, can be set later
