...
namespace TowerDefence.Game.ActionHandler.Stat
{
	public class SpawnHandler : IActionHandler
	{
		...
		public void ApplyAction(GameContext context, TriggerContext trigger, IAction effect)
		{
		...
		public void Rollback(GameContext context, IAction effect)
		{
		...
		public void RemoveEffect(GameContext context, IAction effect)
		{
		...
		public void ApplyAction(in GameContext context, in TriggerContext trigger, IAction effect)
		{
